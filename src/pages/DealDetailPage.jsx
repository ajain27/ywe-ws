...
export default function DealDetailPage() {
  ...
  if (notFound) return <p>This deal could not be found. <Link to="/">Back to all deals</Link></p>

  return (
    <section className="deal-detail">
      <Link to="/" className="back-link">&larr; Back to all deals</Link>
      ...
      <div className="deal-actions">
        {deal.zillowLink && (
          <a className="action-btn zillow-btn" href={deal.zillowLink} target="_blank" rel="noreferrer">
            View on Zillow
          </a>
        )}
        {deal.photosLink && (
          <a className="action-btn photos-btn" href={deal.photosLink} target="_blank" rel="noreferrer">
            View Photos
          </a>
        )}
